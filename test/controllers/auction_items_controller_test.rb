...
class AuctionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction_item" do
    assert_difference("AuctionItem.count") do
      post auction_items_url, params: { auction_item: { current_bid: @auction_item.current_bid, description: @auction_item.description, end_time: @auction_item.end_time, starting_bid: @auction_item.starting_bid, title: @auction_item.title } }
    end
  ...
  test "should update auction_item" do
    patch auction_item_url(@auction_item), params: { auction_item: { current_bid: @auction_item.current_bid, description: @auction_item.description, end_time: @auction_item.end_time, starting_bid: @auction_item.starting_bid, title: @auction_item.title } }
